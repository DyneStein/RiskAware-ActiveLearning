...
class FeatureExtractor:
    ...
    def save_activation(self, module, input, output):
        if isinstance(output, torch.Tensor):
            ...
            # Register gradient hook directly on the activation tensor.
            # This avoids conflicts with inplace ReLU ops that break
            # register_full_backward_hook on architectures like DenseNet.
            self._grad_hook = self.activations.register_hook(self.save_gradient)
        else:
            self.activations = output
